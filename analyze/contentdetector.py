...
class ContentDetector(SceneDetector):
    ...
    def __init__(self, threshold=50.0, min_scene_len=300):
    #def __init__(self, threshold=55.0, min_scene_len=300):
    ...
    def process_frame(self, frame_num, frame_img):
        ...
        if self.last_frame is not None:
            ...
            if (self.stats_manager is not None and
                ...
                if not last_hsv:
                    last_hsv = cv2.split(cv2.cvtColor(self.last_frame, cv2.COLOR_RGB2HSV))
            ...
            if delta_hsv_avg >= self.threshold:
                if self.last_scene_cut is None or (
                    ...
                    self.cut_list.append(frame_num)
